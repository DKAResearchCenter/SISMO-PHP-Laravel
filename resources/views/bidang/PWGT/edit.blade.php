    ...
    <div class="main-content app-content">
        <div class="container-fluid">
            ...
            <div class="d-md-flex d-block align-items-center justify-content-between my-4 page-header-breadcrumb">
                <div class="my-auto">
                    <h5 class="page-title fs-21 mb-1">Edit Data Persekutuan Wanita Gereja Toraja (PWGT)</h5>
                    <nav>
                    ...
                    <div class="card custom-card">
                        ...
                        <div class="card-body">
                            <form method="post" action="./edit">
                                @csrf
                                <input name="id" style="display: none" value="{{ $pwgt->id }}">
                                <div class="row">
                                    <div class="col-6 mb-3">
                                        <label for="form-text" class="form-label fs-14 text-dark">Nama Kegiatan<b style="color='red';">*</b></label>
                                        <input type="text" name="nama" class="form-control" id="form-text" placeholder="" value="{{$pwgt->nama}}">
                                    </div>
                                    <div class="col-6 mb-3">
                                        <label for="form-text" class="form-label fs-14 text-dark">Deskripsi<b style="color='red';">*</b></label>
                                        <input type="text" name="desc" class="form-control" id="form-text" placeholder="" value="{{$pwgt->desc}}">
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-6 mb-3">
                                        <label for="form-text" class="form-label fs-14 text-dark">Anggaran</label>
                                        <input type="number" name="anggaran" class="form-control" id="form-text" placeholder="" value="{{$pwgt->anggaran}}">
                                    </div>
                                    <div class="col-6 mb-3">
                                        <label for="form-text" class="form-label fs-14 text-dark">Tanggal Agenda</label>
                                        <input type="date" name="tanggal_agenda" class="form-control" id="form-text" placeholder="" value="{{$pwgt->tanggal_agenda}}">
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-6 mb-3">
