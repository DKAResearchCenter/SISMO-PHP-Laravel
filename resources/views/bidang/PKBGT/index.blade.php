    ...
    <div class="main-content app-content">
        <div class="container-fluid">
            ...
            <div class="d-md-flex d-block align-items-center justify-content-between my-4 page-header-breadcrumb">
                <div class="my-auto">
                    <h5 class="page-title fs-21 mb-1">Persekutuan Kaum Bapak Gereja Toraja (PKBGT).</h5>
                    <nav>
            ...
            <div class="row">
                <div class="col-xl-12">
                    <a href="PKBGT/create" class="btn btn-lg btn-primary-gradient mb-3">Tambahkan Data Baru</a>
                    <div class="card custom-card">
                        <div class="card-header">

                            <div class="card-title">
                                Data Persekutuan Kaum Bapak Gereja Toraja (PKBGT).
                            </div>
                        </div>
                        <div class="card-body">
