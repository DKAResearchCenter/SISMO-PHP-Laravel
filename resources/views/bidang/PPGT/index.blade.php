    ...
    <div class="main-content app-content">
        <div class="container-fluid">
            ...
            <div class="d-md-flex d-block align-items-center justify-content-between my-4 page-header-breadcrumb">
                <div class="my-auto">
                    <h5 class="page-title fs-21 mb-1">Persekutuan Pemuda Gereja Toraja (PPGT)</h5>
                    <nav>
            ...
            <div class="row">
                <div class="col-xl-12">
                    <a href="PPGT/create" class="btn btn-lg btn-primary-gradient mb-3">Tambahkan Data Baru</a>
                    <div class="card custom-card">
                        <div class="card-header">

                            <div class="card-title">
                                Data Persekutuan Pemuda Gereja Toraja (PPGT)
                            </div>
                        </div>
                        <div class="card-body">
                            <table id="responsivemodal-DataTable" class="table table-bordered text-nowrap w-100">
                                ...
                                <tr>
                                    ...
                                    <th>{{$data->status}}</th>
                                    <td>
                                        <a href="PPGT/edit?id={{$data->id}}" class="btn btn-primary btn-sm"><i class="mdi mdi-pencil"></i></a>
                                        &nbsp;
