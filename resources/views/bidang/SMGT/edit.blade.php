                    ...
                    <div class="card custom-card">
                        ...
                        <div class="card-body">
                            <form method="post" action="./edit">
                                @csrf
                                <input name="id" style="display: none" value="{{ $smgt->id }}">
                                <div class="row">
                                    <div class="col-6 mb-3">
                                        <label for="form-text" class="form-label fs-14 text-dark">Nama Kegiatan<b style="color='red';">*</b></label>
                                        <input type="text" name="nama" class="form-control" id="form-text" placeholder="" value="{{$smgt->nama}}">
                                    </div>
                                    <div class="col-6 mb-3">
                                        <label for="form-text" class="form-label fs-14 text-dark">Deskripsi<b style="color='red';">*</b></label>
                                        <input type="text" name="desc" class="form-control" id="form-text" placeholder="" value="{{$smgt->desc}}">
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-6 mb-3">
                                        <label for="form-text" class="form-label fs-14 text-dark">Anggaran</label>
                                        <input type="number" name="anggaran" class="form-control" id="form-text" placeholder="" value="{{$smgt->anggaran}}">
                                    </div>
                                    <div class="col-6 mb-3">
                                        <label for="form-text" class="form-label fs-14 text-dark">Tanggal Agenda</label>
                                        <input type="date" name="tanggal_agenda" class="form-control" id="form-text" placeholder="" value="{{$smgt->tanggal_agenda}}">
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-6 mb-3">
